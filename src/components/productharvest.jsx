...
import marri from '../images/ind_img2_jarrah.png';

function Productharvest(){
    return(
        <>
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="inner2">
                        ...
                        <h3>Old-Growth Harvest Jarrah Honey</h3>
                        <div className="rg">
                            <img src={stars} alt="" className="img5"/>
                            <p className="para">250 Reviews</p>
                            <p className="p1">300Y+ FAR</p>
                        </div>
