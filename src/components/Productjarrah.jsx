...
import marri from '../images/yt_jarrah.png';

function Productjarrah(){
    return(
        <>
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="inner2">
                        ...
                        <h3>Premium Harvest Jarrah Honey</h3>    {/*header ki position absolute h use utha header show ho jayega.!!!*/ }
                        <div className="rg">
                            <img src={stars} alt="" className="img5"/>
                            <p className="para">85 Reviews</p>
